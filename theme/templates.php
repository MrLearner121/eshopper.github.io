...
<body style="background-color:white" onload="totalprice()" >
  ...
  <header id="header"><!--header-->
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i> +919453523880</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i>shashankpandey0214@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-sm-2">
            <div class="companyinfo">
              ...
              <p>The pain itself is love, the main iterative process, but I give it time.</p>
            </div>
          </div>
          ...
          <div class="col-sm-7">
            <div class="col-sm-6">
              <div class="video-gallery text-center">
                <a href="#"> 
                    <iframe class="iframe-img"  src="https://www.youtube.com/channel/UCVWqzFSZDTlHJ800cgBplVg/videos"   allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> 
                </a> 
              </div>
            </div>
            ...
            <div class="col-sm-6">
              <div class="video-gallery text-center">
                <a href="#"> 
                   <iframe  class="iframe-img"  src="https://www.youtube.com/channel/UCVWqzFSZDTlHJ800cgBplVg/videos" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> 
                </a> 
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-3">
            <div class="address">
              ...
              <p>Kamla Nehru Institute of Technology Sultanpur,Uttar Pradesh India 228118</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="pull-left">Modified by <span><a href="http://surl.li/cbyma">Shashank Pandey</a></span></p>
          <p class="pull-right">Designed by <span><a target="_blank" href="http://www.themeum.com">Shashank Pandey</a></span></p>
        </div>
      </div>
    </div>
