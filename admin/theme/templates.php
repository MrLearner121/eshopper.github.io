        ...
        <nav class="navbar navbar-default navbar-static-top  " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                 ...
                 <a class="navbar-brand"  href="<?php echo web_root; ?>admin/index.php" >E-SHOPPER</a>
            </div>
            <!-- /.navbar-header -->
  ...
  format: 'mm/dd/yyyy',
    ...
    forceParse: 0,
     changeMonth: true,
      ...
      <footer><p  style="text-align: center;font-weight: bold;">Copyright &copy; Bachelor of Technology </p></footer>
</html>