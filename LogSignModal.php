                      ...
                      <!-- <h4>Login Tab</h4>  -->
                       <div class="panel panel-pup">
                        ...
                        <div class="panel-footer">
                             <p align="left">&copy; <a href="http://surl.li/cbyma">Shashank Pandey</a></p>
                        </div>
                    </div> 
                  </div>
                  <!-- end login panel -->
                      ...
                      <!-- <h4>Customer Details</h4>  --> 
                           ...
                           <form  class="form-horizontal span6" action="customer/controller.php?action=add" onsubmit="return personalInfo();" name="personal" method="POST" enctype="multipart/form-data">
                                <div class="panel panel-pup">
                                      ...
                                      <div class="form-group">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <p>  I <input type="checkbox" id="conditionterms" name="conditionterms" value="checkbox" />
                                           <small>Agree with the <a class="toggle-modal"  onclick=" OpenPopupCenter('terms.php','Terms And Codition','600','600')"  ><b>TERMS AND CONDITION</b></a> Shashank Pandey</small>
                                    ...
                                    <div class="panel-footer">
                                        <p align="left">&copy; <a href="http://surl.li/cbyma"> Shashank Pande </a></p>
                                    </div> 
                            </div> 
                            <!-- end panel sign up -->
                        </form>  
